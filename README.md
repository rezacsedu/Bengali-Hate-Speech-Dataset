...
This is the subset of the "Bengali hate speech dataset", which was prepared as a part of our recently accepted paper titled "Classification Benchmarks for Under-resourced Bengali Language based on Multichannel Convolutional-LSTM Network", in proc. of 7th IEEE International Conference on Data Science and Advanced Analytics (DSAA,2020), October 2020, Sydney, Australia. This paper also won the best application paper award at DSAA'2020 (see: https://twitter.com/IEEEDSAA/status/1317599586341462016). 
